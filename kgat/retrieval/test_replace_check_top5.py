...
from data_loader_replace import DataLoaderTest
...
validset_reader = DataLoaderTest(args.test_path_all_data, args.test_path_preattack, args.test_path_postattack, tokenizer, args, batch_size=args.batch_size)
