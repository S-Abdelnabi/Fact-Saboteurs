...
class DataLoaderTest(object):
    ...
    def __init__(self, data_path_all, data_path_preattack, data_path_attack, tokenizer, args, cuda=True, batch_size=64):
        self.cuda = cuda
        ...
        with open(data_path) as fin:
            for step, line in enumerate(fin):
                ...
                for evidence in instance['evidence']:
                    ...
                    evi_list.append([evidence[0],evidence[1],evid_sent,evidence[3]])
